...
import fr.ice.fsm.model.ModelFactory;
...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @see fr.ice.fsm.model.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getState_EntryName() {
	...
	public void createPackageContents() {
		...
		createEAttribute(stateEClass, STATE__ENTRY_NAME);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getState_EntryName(), ecorePackage.getEString(), "entryName", null, 0, 1, State.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getState_Init(), ecorePackage.getEBoolean(), "init", null, 0, 1, State.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFsm_State(), this.getState(), null, "state", null, 0, -1, Fsm.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getFsm_Transition(), this.getTransition(), null, "transition", null, 0, -1, Fsm.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFsm_Name(), ecorePackage.getEString(), "name", null, 0, 1, Fsm.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
