/**
 */
package fr.ice.fsm.model.provider;
...
/**
 * This is the item provider adapter for a {@link fr.ice.fsm.model.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addEntryNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_entryName_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_entryName_feature",
								"_UI_State_type"),
						ModelPackage.Literals.STATE__ENTRY_NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addInitPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_init_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_init_feature", "_UI_State_type"),
						ModelPackage.Literals.STATE__INIT, true, false, false,
